...
def add_cart(request,product_id):
	...
	if current_user.is_authenticated:
		...
		is_cart_item_exsist = CartItem.objects.filter(product=product,user=current_user).exists(	)
		...
		is_cart_item_exsist = CartItem.objects.filter(product=product,cart=cart).exists()
		if is_cart_item_exsist:
